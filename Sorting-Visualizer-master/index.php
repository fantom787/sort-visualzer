...
<head>
    ...
    <title>Sorting visualizer- By Ambuj</title>
</head>
<body>
    <h1 class="title"><a class="title1" href="">Sorting visualizer</a></h1>
    ...
    <footer class="footer">
        <p>
            Created with <i class="fa fa-heart" style="color: #eb2c13"></i> by Ambuj Kumar 
            <br /><br />
            <a href=https://www.linkedin.com/in/ambuj-kumar-88b614203/" target="_blank" class="link">
                <i class="fa fa-linkedin-square" aria-hidden="true"></i>
            </a>
            <a href="https://github.com/fantom787" target="_blank" class="link">
